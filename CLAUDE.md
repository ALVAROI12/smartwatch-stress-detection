...
- With HR/HRV/EDA features, external transfer costs 0.04–0.09 balanced accuracy on all five datasets (WESAD −0.04, PhysioNet −0.04, Stress-Predict −0.07, UBFC-Phys −0.09, Campanella −0.09). That loss is mostly ranking: a best-possible threshold recovers at most 0.04, except 0.08 on UBFC-Phys. A label-free cut matching the source stress rate is not a general fix (it hurts Campanella, 0.821 to 0.733). HR/HRV/EDA is the defensible main feature set.
