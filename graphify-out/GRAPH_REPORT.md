# Graph Report - novelty-plan  (2026-09-24)

## Corpus Check
- 6 files · ~472,704 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 868 nodes · 1561 edges · 47 communities (36 shown, 11 thin omitted)
...
- Tuning & Normalisation Probes
- Stressor Potency & LODO
- Theory Framing (Cacioppo, V3)
- Contribution Map
- Novelty Collision Check
...
2. `Dataset and Claims Verification (full text)` - 24 edges
3. `Contribution Gap Scan (literature scout)` - 24 edges
4. `grouped_split()` - 21 edges
5. `04 Theory Framing: measurement-validity reframe` - 19 edges
6. `Novelty-collision check (2026-09-23)` - 17 edges
7. `Wearable Stress Biomarkers Evidence Report` - 16 edges
8. `What Do Wrist-Worn Stress Detectors Detect? (manuscript)` - 15 edges
9. `normalise()` - 14 edges
10. `main()` - 13 edges

## Surprising Connections (you probably didn't know these)
- `Seven label fixes (commit 6070b6b)` --semantically_similar_to--> `Label audit of five public E4 datasets (Sec. III)`  [INFERRED] [semantically similar]
  CLAUDE.md → paper/main.pdf
...
- `Committee report (contribution_report_ieee.pdf)` --conceptually_related_to--> `Central claim: wrist detectors transfer because they detect autonomic arousal`  [INFERRED]
  STATUS.md → paper/main.pdf
- `Label audit of five public E4 datasets (Sec. III)` --conceptually_related_to--> `Four pipeline defects (subject leak, WESAD misalignment, unfiltered BVP, PhysioNet whole-session labels)`  [INFERRED]
  paper/main.pdf → CLAUDE.md
...
- **Evidence chain for the arousal-not-stress central claim** — paper_main_matched_arousal_test, paper_main_specificity_panel, paper_main_arousal_index, paper_main_iso_hr_test, docs_novelty_plan_2026_09_23_stressor_potency, paper_main_arousal_not_stress_claim [EXTRACTED 1.00]
- **Five public E4 datasets in leave-one-dataset-out** — paper_main_wesad, paper_main_physionet, paper_main_stress_predict, paper_main_ubfc_phys, readme_campanella_2024_dataset, paper_main_lodo_evaluation [EXTRACTED 1.00]
- **Theory frames supporting the critical-evaluation framing** — docs_novelty_plan_2026_09_23_cacioppo_inference, docs_novelty_plan_2026_09_23_shortcut_learning, docs_novelty_plan_2026_09_23_v3_framework, docs_novelty_plan_2026_09_23_challenge_threat, docs_novelty_plan_2026_09_23_critical_evaluation_framing [EXTRACTED 1.00]

## Communities (47 total, 11 thin omitted)

### Community 0 - "Feature Extraction (HR/HRV/EDA)"
Cohesion: 0.06
Nodes (59): functools, neurokit2, numpy, pandas, pathlib, pickle, cardiac_features(), clean_beats() (+51 more)

### Community 1 - "Tuning & Normalisation Probes"
Cohesion: 0.07
Nodes (54): FixedTrial, optuna, fit_predict(), main(), DataFrame, ndarray, Which personal normalisation helps stress detection transfer, and is the gain…, Window minus the median of the same recording's strictly earlier, non-… (+46 more)

### Community 2 - "Stressor Potency & LODO"
Cohesion: 0.06
Nodes (41): Analysis B: stressor-potency dose-response, R4: stressor potency untested, os, Fig2: Leave-One-Dataset-Out (HR/HRV/EDA), Same-dataset vs other-datasets-only vs all-datasets training (HR/HRV/EDA, 20 splits), Stress-Predict lowest balanced accuracy (~0.65 external, ~0.70 within), Paper Fig: LODO Bar Chart (with/without temperature), Leave-one-dataset-out transfer cost (+33 more)

### Community 3 - "Theory Framing (Cacioppo, V3)"
Cohesion: 0.05
Nodes (51): 04 Theory Framing: measurement-validity reframe, Allostasis: detector as metabolic mobilisation index, Analysis A: SAM felt arousal vs valence against detector score, Analysis B: PPG pulse amplitude and WESAD pulse arrival time as vascular channel, Analysis C: deployment PPV via Bayes on specificity-panel rates, Autonomic specificity debate, Cacioppo, Tassinary & Berntson (2007) Handbook of Psychophysiology ch. 1, Cacioppo & Tassinary (1990) Am Psychol (+43 more)

### Community 4 - "Contribution Map"
Cohesion: 0.06
Nodes (35): Akkaya 2026, Counterbalanced UTSA lab study, docs/literature/contribution-gap-scan.md, Error budget (Shapley-averaged test-side filters), Farahani et al. 2026, Five-dataset benchmark release, Hardening probes, Label-free arousal index (+27 more)

### Community 5 - "Novelty Collision Check"
Cohesion: 0.09
Nodes (41): Novelty-collision check (2026-09-23), Aydogan & Villagra Povina 2026 (Med Eng Phys) Stress or arousal?, Bosch et al. 2026 (Int J Psychophysiol), Claim: detectors detect arousal, not stress, Claim: five-dataset E4 leave-one-dataset-out, Claim: label audit of five public E4 datasets, Claim: matched-arousal specificity test (HR + tonic EDA index), Claim: specificity panel of non-stress states (+33 more)

### Community 6 - "Model Comparison Stats"
Cohesion: 0.08
Nodes (35): argparse, io, itertools, scipy, compare(), corrected_ttest(), holm(), main() (+27 more)

### Community 7 - "Project Memory (CLAUDE.md)"
Cohesion: 0.08
Nodes (40): CLAUDE.md (JBHI revision settled facts), Arousal kit (scripts/arousal_kit.py), Contribution map (docs/contribution_map.md), CORAL/MMD/DANN domain adaptation null result, Few-shot personalisation (leakage-controlled negative), Four pipeline defects (subject leak, WESAD misalignment, unfiltered BVP, PhysioNet whole-session labels), Seven label fixes (commit 6070b6b), Working rule: split by subject, never by window (+32 more)

### Community 8 - "Novelty Experiments"
Cohesion: 0.07
Nodes (35): UBFC-Phys missing-temperature threshold shift, Per-subject whole-session z-scoring (transductive), Iqbal et al. 2022, Few-shot calibration on unseen dataset, Kwon et al. setting (WESAD + Stress-Predict), Mild-stress pilot, Normalisation variants (session, raw, baseline, causal), Frozen PaPaGei / Pulse-PPG encoder under LODO (step 6) (+27 more)

### Community 9 - "Legacy API"
Cohesion: 0.08
Nodes (27): BaseModel, fastapi, get, joblib, json, get_model_info(), health_check(), predict() (+19 more)

### Community 10 - "Novelty Search Papers"
Cohesion: 0.06
...
### Community 11 - "Domain Adaptation & Few-Shot"
Cohesion: 0.13
...
### Community 12 - "Contribution Gap Scan"
Cohesion: 0.08
Nodes (28): Contribution Map Report for the JBHI Revision (IEEE), Audited Five-Dataset Benchmark Release, Foundation-Model Check, Contribution Gap Scan (literature scout), Abdel-Ghaffar et al. 2025 (Fitbit Body Response), Alchieri et al. 2026 (UME), Brandebusemeyer et al. 2026, EmoWork Dataset (2025) (+20 more)

### Community 13 - "Harmonization Audit"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (19): Arousal-controlled evaluation kit, Arousal plus residual decomposition, Equivalence bounds and minimum detectable effect, Iso-HR test (Kwon et al. 2026 replication), Probe states vs rest at matched arousal, Task engagement as the model's non-arousal component, Untrained arousal index (z hr_mean + z eda_tonic_mean), Challenge vs threat (Seery; Blascovich) (+11 more)

### Community 15 - "Biomarker Evidence Report"
Cohesion: 0.10
...
### Community 16 - "Frozen Subject Splits"
Cohesion: 0.19
Nodes (21): csv, hashlib, build_group_table(), file_sha256(), generate_repeated_splits(), load_dataset(), main(), max_unique_test_signatures() (+13 more)

### Community 17 - "Legacy Robustness & Active Learning"
Cohesion: 0.13
...
### Community 18 - "Paper Figure Builder"
Cohesion: 0.16
...
### Community 19 - "Dataset Label Fixes"
Cohesion: 0.10
...
### Community 20 - "Frozen Split Evaluation"
Cohesion: 0.19
...
### Community 21 - "Legacy Six Classes"
Cohesion: 0.18
...
### Community 23 - "Legacy Feature Correlation"
Cohesion: 0.18
...
### Community 24 - "Legacy Model Enhancements"
Cohesion: 0.20
...
### Community 25 - "Legacy Anomaly Detection"
Cohesion: 0.25
...
### Community 26 - "Legacy Confusion & Conformal"
Cohesion: 0.22
...
### Community 27 - "Self-Report Labels"
Cohesion: 0.50
...
### Community 28 - "Novelty Candidates Brief"
Cohesion: 0.33
...
### Community 29 - "Legacy Leakage Symptoms"
Cohesion: 0.33
...
### Community 30 - "Legacy Hyperparameter Plots"
Cohesion: 0.50
...
### Community 31 - "Wrist vs Chest ECG Figure"
Cohesion: 0.50
...
### Community 35 - "Normalisation Figure"
Cohesion: 0.67
...
## Knowledge Gaps
- **152 isolated node(s):** `Stress-Predict (reading list)`, `WESAD (reading list)`, `Basaran et al. 2024`, `Cheng et al. 2022`, `Cukic et al. 2023` (+147 more)
...
- **Why does `Novelty Search for the JBHI Rewrite` connect `Novelty Search Papers` to `Window Leakage Prior Work`, `Feature Extraction (HR/HRV/EDA)`, `Order Confound Prior Work`, `Few-Shot Prior Work`, `Missing Channel Prior Work`, `Wrist HRV Prior Work`, `Domain Adaptation & Few-Shot`, `Contribution Gap Scan`, `Dataset Label Fixes`, `Novelty Candidates Brief`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `Contribution Map Report for the JBHI Revision (IEEE)` connect `Contribution Gap Scan` to `Tuning & Normalisation Probes`, `Stressor Potency & LODO`, `Contribution Map`, `Project Memory (CLAUDE.md)`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `What Do Wrist-Worn Stress Detectors Detect? (manuscript)` connect `Project Memory (CLAUDE.md)` to `Theory Framing (Cacioppo, V3)`, `Contribution Gap Scan`, `Arousal-Controlled Evaluation Kit`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **What connects `Stress-Predict (reading list)`, `WESAD (reading list)`, `Basaran et al. 2024` to the rest of the system?**
...
- **Should `Tuning & Normalisation Probes` be split into smaller, more focused modules?**
  _Cohesion score 0.07431693989071038 - nodes in this community are weakly interconnected._
- **Should `Stressor Potency & LODO` be split into smaller, more focused modules?**
